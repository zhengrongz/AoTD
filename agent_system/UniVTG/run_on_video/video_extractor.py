...
import numpy as np
import torch
from UniVTG.run_on_video.video_loader import VideoLoader
...
def vid2clip(model, vid_path, output_file, 
             ...
             clip_len=1, overwrite=True, num_decoding_thread=4, half_precision=False):
    #print(f"123:{vid_path}")
    dataset = VideoLoader(
        vid_path,
    ...
    return vid_features, totatl_num_frames, fps
